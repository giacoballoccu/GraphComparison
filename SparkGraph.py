...
class SparkGraph:
    def __init__(self, spark_session, nodes_csv, edges_csv):
        ...
        edges_df = pd.read_csv('/content/musae_ENGB_edges.csv', names=cols_names_edges, header=1)
        nodes_df = pd.read_csv('/content/musae_ENGB_target.csv', names=cols_names_nodes, header=1)
